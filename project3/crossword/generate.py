...
class CrosswordCreator():
    ...
    def satisfy(self, value, x, y):
        """
        Check if there is a corresponding value for x in y
        """
    ...
    def consistent(self, assignment):
        ...
        for variable in assignment:
            ...
            for neighbor in self.crossword.neighbors(variable):
                if neighbor in assignment and self.crossword.overlaps[variable, neighbor]:
    ...
    def order_domain_values(self, var, assignment):
        ...
        """
        ruled_out = dict.fromkeys(self.domains[var], 0)
